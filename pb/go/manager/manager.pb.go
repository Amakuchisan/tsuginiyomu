...
type Article struct {
	...
	WordCount map[string]float64 `protobuf:"bytes,2,rep,name=word_count,json=wordCount,proto3" json:"word_count,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"fixed64,2,opt,name=value,proto3"`
}
...
func (x *Article) GetWordCount() map[string]float64 {
	if x != nil {
		return x.WordCount
	}
	return nil
...
type GetWordReply struct {
	...
	WordCount map[string]float64 `protobuf:"bytes,1,rep,name=wordCount,proto3" json:"wordCount,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"fixed64,2,opt,name=value,proto3"`
}
...
func (x *GetWordReply) GetWordCount() map[string]float64 {
	if x != nil {
		return x.WordCount
	}
	return nil
...
var file_manager_proto_rawDesc = []byte{
	...
	0x63, 0x6c, 0x6f, 0x75, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x09, 0x77, 0x6f, 0x72,
	0x64, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x22, 0x44, 0x0a, 0x14, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65,
