...
goog.exportSymbol('proto.learner.GetHotentrySuggestionRequest', null, global);
 ...
 * @constructor
 */
proto.learner.GetHotentrySuggestionRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.learner.GetHotentrySuggestionRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.learner.GetHotentrySuggestionRequest.displayName = 'proto.learner.GetHotentrySuggestionRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.learner.GetHotentrySuggestionRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.learner.GetHotentrySuggestionRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.learner.GetHotentrySuggestionRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.learner.GetHotentrySuggestionRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    hatenaId: jspb.Message.getFieldWithDefault(msg, 1, ""),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.learner.GetHotentrySuggestionRequest}
 */
proto.learner.GetHotentrySuggestionRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.learner.GetHotentrySuggestionRequest;
  return proto.learner.GetHotentrySuggestionRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.learner.GetHotentrySuggestionRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.learner.GetHotentrySuggestionRequest}
 */
proto.learner.GetHotentrySuggestionRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.learner.GetHotentrySuggestionRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.learner.GetHotentrySuggestionRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.learner.GetHotentrySuggestionRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.learner.GetHotentrySuggestionRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getHatenaId();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.learner.GetHotentrySuggestionRequest.prototype.getHatenaId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.learner.GetHotentrySuggestionRequest} returns this
 */
proto.learner.GetHotentrySuggestionRequest.prototype.setHatenaId = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.learner.GetHotentrySuggestionRequest.prototype.getCategory = function() {
 ...
 * @return {!proto.learner.GetHotentrySuggestionRequest} returns this
 */
proto.learner.GetHotentrySuggestionRequest.prototype.setCategory = function(value) {
